        ...
        <el-form :model="bankForm">
          <table style="width: 100%" border="1">
            <tr>
              ...
              <td>
                <!-- <el-select v-model="bankForm.value"  placeholder="请选择" style="width: 370px;">
                  <el-option
                    v-for="item in bankForm.qyeryaccounttypelist"
                    :key="item.code"
                    :label="item.codeName"
                    :value="item.code"
                  ></el-option>
                </el-select> -->
                 <el-input v-model="bankForm.depositorType" readonly></el-input>
              </td>
            </tr>
            <tr>
           ...
           <tr>
              ...
              <td>
                <el-input v-model="bankForm.createTime"></el-input>
              </td>
            </tr>
            <tr>
              <td class="bg_color">提交时间：</td>
              <td>
                <el-input v-model="bankForm.submitTime"></el-input>
              </td>
            </tr>
          </table>
          <el-row>
...
export default {
  ...
  created() {
    this.bankForm = this.$route.query;
  },
  methods: {
    backtrack() {
      this.$router.push({ path: "/BankAccountlist" });
    }
  }
}
</script>
