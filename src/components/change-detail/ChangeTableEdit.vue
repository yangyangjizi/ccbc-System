            ...
            <tr>
              ...
              <td>
                <el-select v-model="vioForm.checkAccountType" placeholder="请选择" style="width:100%">
                  <el-option
                    v-for="(item,index) in checkAccountTypeList"
                    :key="index"
                    :label="item.codeName"
                    :value="item.code"
                  ></el-option>
            ...
            <tr>
              ...
              <td>
                <el-select v-model="vioForm.ifdubiousDeal" placeholder="请选择" style="width:100%">
                  <el-option
                    v-for="(item,index) in ifdubiousDealList"
                    :key="index"
                    :label="item.label"
                    :value="item.code"
                  ></el-option>
            ...
            <tr>
              ...
              <td>
                <el-select v-model="vioForm.ifreorganize" placeholder="请选择" style="width:100%">
                  <el-option
                    v-for="(item,index) in ifreorganizeList"
                    :key="index"
                    :label="item.label"
                    :value="item.code"
                  ></el-option>
  ...
  methods: {
    ...
    handleSave() {
      ...
      axios({
        method: "post",
        data: req,
        url: "/banksys/riskinspect/editriskinspectbyid.do"
      })
        .then(res => {
