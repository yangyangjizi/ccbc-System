  ...
  <section>
    ...
    <el-col :span="24" class="toolbar">
      ...
      >
        ...
        >
          <el-form-item label="核查内容：" prop="checkOne">
            <el-select v-model="newCheckForm.checkOne" placeholder="请选择核查内容">
              <el-option
          ...
          <el-form-item label="核查结果：" prop="checkResult">
            <el-select v-model="newCheckForm.checkResult" placeholder="请选择核查结果">
              <el-option
      ...
      <div class="v_add2">
        ...
        >
          ...
          <el-table-column prop="detecData" label="核查内容" align="center" show-overflow-tooltip></el-table-column>
          <el-table-column prop="ifPass" label="核查结果" align="center" show-overflow-tooltip>
          ...
          <el-table-column prop="detectionType" label="核查类型" align="center" show-overflow-tooltip></el-table-column>
      ...
      <!-- 列表详情弹框 -->
      <el-dialog title="日常核查详情" :visible.sync="dialogTableDetailVisible" width="40%" center>
...
export default {
  data() {
    return {
      ...
      newCheckFormRules: {
        checkOne: [
          { required: true, message: "请选择核查内容", trigger: "change" }
        ],
        checkResult: [
  ...
  methods: {
    ...
    handleYes(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          this.fd.append("takeSteps", this.newCheckForm.newGenData);
    ...
    backtrack() {
      this.$router.push({ path: "/DailyCheck" });
    },
    handleContent() {
      let req = {};
      req = {
