    ...
    <el-col :span="24" class="toolbar" v-if="!loading">
      ...
      <div class="margin-box99">
        ...
        <div style="float:left">
          ...
          >手动分发</el-button>
          <el-button type="info" v-on:click="handleYearCheck" v-hasPermission="'accInforCheck'">流动排查</el-button>
        </div>
      ...
      <!-- 弹出流动排查 -->
      <el-dialog :visible.sync="dialogYearCheck" title="流动排查" width="30%" center>
        <el-form :model="yearCheckForm" :label-width="labelWidth" class="el-form-box">
          <el-form-item label="流动排查数据:">
            <el-select
