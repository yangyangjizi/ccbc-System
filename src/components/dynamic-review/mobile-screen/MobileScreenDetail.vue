  ...
  <section>
    ...
    <el-col :span="24" class="toolbar">
      ...
      >
        ...
        >
          <el-form-item label="排查内容：" prop="checkOne">
            <el-select v-model="newCheckForm.checkOne" placeholder="请选择排查内容">
              <el-option
          ...
          <el-form-item label="排查结果：" prop="checkResult">
            <el-select v-model="newCheckForm.checkResult" placeholder="请选择排查结果">
              <el-option
          ...
          <el-form-item label="不合格原因：">
            <el-input v-model="newCheckForm.noPassReason" class="input-box4" type="textarea"
              :rows="2" ></el-input>
          </el-form-item>
          <el-form-item label="人行账户信息：">
            <el-input v-model="newCheckForm.peopleAccData " class="input-box4" type="textarea"
              :rows="2"></el-input>
          </el-form-item>
          <el-form-item label="新一代客户数据：">
            <el-input v-model="newCheckForm.newGenData" class="input-box4" type="textarea"
              :rows="2"></el-input>
          </el-form-item>
          <el-form-item label="工商数据：">
            <el-input v-model="newCheckForm.busiData" class="input-box4" type="textarea"
              :rows="2"></el-input>
          </el-form-item>
          ...
          <el-form-item label="备注：">
            <el-input v-model="newCheckForm.remark" class="input-box4" type="textarea"
              :rows="2"></el-input>
          </el-form-item>
      ...
      <div class="v_add2">
        ...
        >
          ...
          <el-table-column prop="detecData" label="排查内容" align="center" show-overflow-tooltip></el-table-column>
          <el-table-column prop="ifPass" label="排查结果" align="center" show-overflow-tooltip>
          ...
          <el-table-column prop="detectionType" label="排查类型" align="center" show-overflow-tooltip></el-table-column>
      ...
      <!-- 列表详情弹框 -->
      <el-dialog title="流动排查详情" :visible.sync="dialogTableDetailVisible" width="40%" center>
...
export default {
  data() {
    return {
      ...
      newCheckFormRules: {
        ...
        checkResult: [
          { required: true, message: "请选择排查结果", trigger: "change" }
        ],
        staffName: [
  ...
  methods: {
    ...
    // 获取采取措施下拉数据
    takeStepsListData(){
      this.$axios.post('/banksys/system/common/querycode.do',{codeTypes:"take_steps"}).then(res =>{
        this.takeStepsList = res.data.list
      }).catch(err => { this.$message.error("网络异常，请重试！！！")})
    },
    // 详情文件展示点击下载相应文件
    handlePreview(file) {
      let prop = {};
    ...
    backtrack() {
      this.$router.push({ path: "/MobileScreen" });
    },
    handleContent() {
      let req = {};
      req = { depositorId: this.depositorId, pageType: "6", depositorName: this.depositorName };
      axios({
        method: "post",
