          ...
          <tr>
           ...
           <tr>
            ...
            <tr>
              ...
              <td>
                <el-select v-model="epiForm.depositorType" placeholder="请选择" class="el-select-box">
                  <el-option
            ...
            <tr>
              ...
              <td>
                <el-select v-model="epiForm.accountType" placeholder="请选择" class="el-select-box">
                  <el-option
             ...
             <tr>
              ...
              <td>
                <el-select v-model="epiForm.entbankType" placeholder="请选择" class="el-select-box">
                  <el-option
    ...
    this.gettradeType(), this.getdepositorType(),this.getaccountType()
     ...
     handleSave(){
      ...
      req = {
        ...
        depositorType: this.epiForm.depositorType,
        accountType:this.epiForm.accountType,
        entbankType:this.epiForm.entbankType,
        ...
        method: "post",
        data: req,
        url: "/banksys/enteraccount/saveenteraccount.do"
      }).then(res => {
